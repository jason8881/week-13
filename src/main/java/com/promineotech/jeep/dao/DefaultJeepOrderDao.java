...
import com.promineotech.jeep.dao.DefaultJeepOrderDao.CustomerResultSetExtractor.SqlParams;
...
import com.promineotech.jeep.enitiy.FuelType;
...
import com.promineotech.jeep.enitiy.OptionType;
	...
	class CustomerResultSetExtractor implements ResultSetExtractor<Customer> {
		...
		@Autowired
		  ...
		  public List<Option> fetchOptions(List<String> optionIds) {
		    ...
		    return jdbcTemplate.query(sql, params, new org.springframework.jdbc.core.RowMapper<Option>() {
